...
// import onboardingTutorialSteps from '@/lib/onboardingTutorialSteps';
...
// function TutorialManager({ children }: { children: React.ReactNode }) {
// 	const { user, loading } = useAuth();
// 	const [showModal, setShowModal] = useState(false);
// 	const [showTutorial, setShowTutorial] = useState(false);
// 	useEffect(() => {
// 		if (!loading && user) {
// 			// Only show modal on first login in this session
// 			if (!window.sessionStorage.getItem('tutorialModalShown')) {
// 				setShowModal(true);
// 				window.sessionStorage.setItem('tutorialModalShown', '1');
// 			}
// 		}
// 	}, [user, loading]);
// 	return (
