...
export default function JeopardyCreatePage() {
	...
	const [selectedPreset, setSelectedPreset] = useState<ValuePreset>(
		VALUE_PRESETS[0]
	);
	const [customValues, setCustomValues] = useState<number[]>([
		100, 200, 300, 400, 500,
	]);
	const [currentMode, setCurrentMode] = useState<'content' | 'styling'>(
		'content'
	);
	...
	const [selectedAnimation, setSelectedAnimation] = useState<AnimationStyle>(
		ANIMATION_STYLES[0]
	);
					...
					>
						...
						<div className="max-w-2xl mx-auto mb-8 px-6">
							...
							<input
								...
								style={{
									backgroundColor:
										selectedTheme.questionCellBackground,
							...
							>
								...
								>
									...
									{categories.map((category, index) => (
										<div
											key={`category-${index}`}
											className="relative p-4 text-center rounded-lg font-semibold group"
											style={{
												backgroundColor:
													selectedTheme.categoryBackground,
												color: selectedTheme.categoryTextColor,
											}}
										>
											{category}
												...
												return (
													<motion.div
														...
														style={{
															backgroundColor:
																isCompleted
																	? selectedTheme.completedCellBackground
																	: selectedTheme.questionCellBackground,
															color: isCompleted
																? selectedTheme.completedCellTextColor
																: selectedTheme.questionTextColor,
															borderColor:
														...
														whileHover={{
															...
															backgroundColor:
																selectedTheme.questionCellHoverBackground,
															zIndex: 10,
														}}
														whileTap={{
											...
											style={{
												...
												borderColor:
													...
													theme.id
														...
														: theme.borderColor,
												background:
													theme.backgroundColor.includes(
														'gradient'
													)
