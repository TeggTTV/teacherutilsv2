		...
		>
			...
			>
				<div className="text-center">
					<p className="text-sm font-semibold text-gray-900 mb-2">Compyy Dashboard</p>
					<p className="text-xs text-gray-600 leading-relaxed">Create, play, and discover educational games</p>
				</div>
			</motion.div>
		</motion.div>
	);
