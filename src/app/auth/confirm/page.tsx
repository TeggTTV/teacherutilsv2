				...
				<div className="bg-white rounded-2xl shadow-xl p-8 text-center">
					...
					>
						<Link href={getButtonLink()}>
							<button className="w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg transition duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
								{getButtonText()}
							</button>
						</Link>
					</motion.div>
