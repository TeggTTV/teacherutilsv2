				...
				<div className="max-w-3xl mx-auto text-center">
					...
					>
						...
						<p className="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8 px-2">
							Subscribe to our newsletter and receive a pack of
							premium educational game templates worth $50 -
							absolutely free!
						</p>
						<div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-lg">
							...
							<p className="text-xs sm:text-sm text-gray-500 mt-3 sm:mt-4">
								Join a growing community of teachers who already
								trust Compyy. Unsubscribe anytime.
							</p>
						</div>
					</motion.div>
				</div>
