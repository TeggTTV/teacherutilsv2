				...
				<div className="max-w-md mx-auto px-4">
					...
					<Link href="/create/">
						<motion.button
							...
							whileTap={{ scale: 0.98 }}
							className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold transition-all duration-200 shadow-lg hover:shadow-xl inline-flex items-center space-x-3"
						>
			...
			<div className="flex justify-between items-center">
				...
				<Link href="/create/question-set">
					<motion.button
						whileHover={{ scale: 1.02 }}
						whileTap={{ scale: 0.98 }}
						className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2.5 rounded-lg font-medium transition-all duration-200 shadow-sm hover:shadow-md inline-flex items-center space-x-2"
					>
